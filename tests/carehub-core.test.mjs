...
assert.equal(visualization.wardType, "2.5D Digital Twin");
assert.equal(visualization.wardBeds[2].pressureStatus, "High");
assert.equal(visualization.wardBeds[2].ivStatus, "Urgent");
assert.equal(visualization.wardBeds[2].twinVariant, "priority");
